    ...
    if (this.state.list === 'watch') {
      if (!this.state.locker) {
        fetch(`${apiUrl}/watch/load`, {
          ...
          .then((result) => {
            const newData = this.state.watchData.concat(result);
            if (result.length === 20) {
      ...
      if (!this.state.loveLocker) {
        fetch(`${apiUrl}/watch/load`, {
          ...
          .then((result) => {
            const newLove = this.state.loveData.concat(result);
            if (result.length === 20) {
              this.setState({
      ...
      if (!this.state.commentLocker) {
        fetch(`${apiUrl}/watch/load`, {
          ...
          .then((result) => {
            const newComment = this.state.commentData.concat(result);
            if (result.length === 20) {
              this.setState({
        ...
        ListHeaderComponent={() => (
          <View style={styles.rootHeader}>
            ...
            >
              <View
                style={
                  this.state.list === 'watch' ? styles.headerContain : styles.headerChoose
                }
              >
                <Image
            ...
            >
              <View
                style={
                  this.state.list === 'love' ? styles.headerContain : styles.headerChoose
                }
              >
                <Image
            ...
            >
              <View
                style={
                  this.state.list === 'comment' ? styles.headerContain : styles.headerChoose
                }
              >
                <Image
