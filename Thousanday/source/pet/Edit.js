...
import {
  StyleSheet, Text, View, TextInput, TouchableOpacity, Image, Button, ScrollView, RefreshControl
} from 'react-native';
  ...
  componentDidMount() {
    fetch(`${apiUrl}/edit/read?pet=${this.props.id}&user=${this.props.userId}`, {
      ...
      .then((data) => {
        this.setState({
          name: data.pet_name,
          role: parseInt(data.owner_id, 10) === this.props.userId,
              ...
              this.state.getName && this.state.search ? (
                <View style={styles.confirmInfo}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={
                      parseInt(this.state.search, 10) === this.props.userId ?
